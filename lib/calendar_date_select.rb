...
if Object.const_defined?(:Rails) && File.directory?(Rails.root.to_s + "/public")
  ...
  # install files
  if !File.exists?(Rails.root + '/public/javascripts/calendar_date_select/calendar_date_select.js') and !File.exists?(Rails.root + '/app/assets/javascripts/calendar_date_select/calendar_date_select.js')
